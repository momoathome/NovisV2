...
const node_modules__pnpm_nuxt_643_0_0_rc_8_wjgdfmzd44uxx2ctknxhvnu2pm_node_modules_nuxt_dist_head_runtime_lib_vueuse_head_plugin_mjs_0AeJwKOdXb = defineNuxtPlugin((nuxtApp) => {
...
const metaConfig = { "globalMeta": { "meta": [{ "hid": "description", "name": "description", "content": "NovisV2 Template" }], "link": [{ "rel": "icon", "type": "image/x-icon", "href": "/favicon.ico" }], "style": [], "script": [], "noscript": [], "title": "NovisV2", "charset": "utf-8", "viewport": "width=device-width, initial-scale=1" } };
const metaMixin = {
  created() {
...
const node_modules__pnpm_nuxt_643_0_0_rc_8_wjgdfmzd44uxx2ctknxhvnu2pm_node_modules_nuxt_dist_head_runtime_plugin_mjs_xD1YSVD7aP = defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$7 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "flex flex-col justify-center text-center p-4 transition transition-duration-500 cursor-pointer hover:scale-110" }, _attrs))} data-v-9d0d96e0><img${serverRenderer.exports.ssrRenderAttr("src", `/img/${__props.newsItem.img}.webp`)} class="rounded-full w-min self-center img-shadow" alt="" data-v-9d0d96e0><h3 class="text-white text-2xl mt-6 mb-0 uppercase" data-v-9d0d96e0>${serverRenderer.exports.ssrInterpolate(__props.newsItem.title)}</h3><p class="m-0 text-sm font-bold uppercase font-sans" data-v-9d0d96e0>${serverRenderer.exports.ssrInterpolate(__props.newsItem.date)}</p></div>`);
    };
  }
});
...
_sfc_main$7.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/default/NewsItem.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-9d0d96e0"]]);
const _sfc_main$6 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  __name: "NewsPreviewSlider",
  __ssrInlineRender: true,
  props: {
    news: Array
  },
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_DefaultNewsItem = __nuxt_component_0$2;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "grid grid-cols-4 justify-around m-block-10 w-full h-33% overflow-hidden" }, _attrs))}><!--[-->`);
      serverRenderer.exports.ssrRenderList(__props.news, (item, index) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_DefaultNewsItem, {
          key: index,
          newsItem: item
        }, null, _parent));
      });
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/default/NewsPreviewSlider.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<button${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    type: "button",
    class: "cursor-pointer font-sans tracking-1px uppercase font-bold relative inline-block z-0 px-4 py-2 text-xs whitespace-nowrap md:px-8 md:py-3 md:text-sm xl:px-12 xl:py-4 rounded-lg shadow-xl border-none bg-transparent text-white transition-all transition-duration-300 before:content-empty before:absolute before:z--1 before:inset-0 before:px-2px before:py-2px before:transition-all before:rounded-lg"
  }, _attrs))} data-v-808c0e65>`);
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/default/PrimaryButton.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-808c0e65"]]);
const _sfc_main$4 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-881720c8><div class="bg-base_light relative flex w-full h-max p-24 rounded-xl shadow-black/20 shadow-md" data-v-881720c8><div class="left-col" data-v-881720c8><div class="flex justify-between mb-2" data-v-881720c8><div class="flex gap-4" data-v-881720c8><!--[-->`);
      serverRenderer.exports.ssrRenderList(__props.newsObject.tags, (tag, index) => {
        _push(`<p class="m-0 text-sm uppercase font-bold text-primary font-sans" data-v-881720c8>${serverRenderer.exports.ssrInterpolate(tag)}</p>`);
      });
      _push(`<!--]--></div><div data-v-881720c8><p class="uppercase font-bold text-sm m-0 tracking-1px" data-v-881720c8>${serverRenderer.exports.ssrInterpolate(__props.newsObject.date)}</p></div></div><h2 class="text-white m-0 uppercase text-3xl" data-v-881720c8>${serverRenderer.exports.ssrInterpolate(__props.newsObject.title)}</h2><div class="max-w-65ch" data-v-881720c8><p class="text-sm m-0 mt-8 leading-6 font-sans" data-v-881720c8>${serverRenderer.exports.ssrInterpolate(__props.newsObject.content)}</p><p class="text-sm m-0 mt-4 leading-6 font-sans" data-v-881720c8>${serverRenderer.exports.ssrInterpolate(__props.newsObject.content)}</p></div>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_DefaultPrimaryButton, { class: "mt-16" }, {
      ...
      _push(`</div><div class="absolute top-50% right--15 translate-y--50% z-10" data-v-881720c8><img${serverRenderer.exports.ssrRenderAttr("src", __props.newsObject.contentImg)} alt="" class="rounded-10px shadow-lg shadow-black/20" data-v-881720c8></div></div></div>`);
    };
  }
});
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/default/NewsView.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-881720c8"]]);
const _sfc_main$3 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  __name: "NewsViewSlider",
  __ssrInlineRender: true,
  props: {
    news: Array
  },
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_DefaultNewsView = __nuxt_component_0$1;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "relative h-67% w-full" }, _attrs))}><!--[-->`);
      serverRenderer.exports.ssrRenderList(__props.news, (object, index) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_DefaultNewsView, {
          key: index,
          newsObject: object
        }, null, _parent));
      });
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/default/NewsViewSlider.vue");
...
const _sfc_main$2 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_DefaultNewsPreviewSlider = _sfc_main$6;
      const _component_DefaultNewsViewSlider = _sfc_main$3;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "container w-1140px m-auto pb-100px" }, _attrs))}><h1 class="text-5xl text-center m-0 text-white uppercase">News</h1><div class="flex flex-col h-100vh">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_DefaultNewsPreviewSlider, { news: newsItems }, null, _parent));
      _push(serverRenderer.exports.ssrRenderComponent(_component_DefaultNewsViewSlider, { news: newsItems }, null, _parent));
      _push(`</div></div>`);
    };
  }
});
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/default/News.vue");
...
const routes = [
  {
    name: "downloads",
    path: "/downloads",
    file: "D:/1Code/NovisV2/pages/downloads.vue",
    children: [],
    meta: meta$8,
    alias: [],
    component: () => import('./downloads.04c6ffcb.mjs').then((m) => m.default || m)
  },
  {
    name: "faq",
    path: "/faq",
    file: "D:/1Code/NovisV2/pages/faq.vue",
    children: [],
    meta: meta$7,
    alias: [],
    component: () => import('./faq.48c6811f.mjs').then((m) => m.default || m)
  },
  {
    name: "features",
    path: "/features",
    file: "D:/1Code/NovisV2/pages/features.vue",
    children: [],
    meta: meta$6,
    alias: [],
    component: () => import('./features.83e27f41.mjs').then((m) => m.default || m)
  },
  {
    name: "guides",
    path: "/guides",
    file: "D:/1Code/NovisV2/pages/guides.vue",
    children: [],
    meta: meta$5,
    alias: [],
    component: () => import('./guides.24039b6c.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    file: "D:/1Code/NovisV2/pages/index.vue",
    children: [],
    meta: meta$4,
    alias: [],
    component: () => import('./index.10056e97.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    file: "D:/1Code/NovisV2/pages/login.vue",
    children: [],
    meta: meta$3,
    alias: [],
    component: () => import('./login.0c7308f1.mjs').then((m) => m.default || m)
  },
  {
    name: "rankings",
    path: "/rankings",
    file: "D:/1Code/NovisV2/pages/rankings.vue",
    children: [],
    meta: meta$2,
    alias: [],
    component: () => import('./rankings.49f4d101.mjs').then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    file: "D:/1Code/NovisV2/pages/register.vue",
    children: [],
    meta: meta$1,
    alias: [],
    component: () => import('./register.fb0915f9.mjs').then((m) => m.default || m)
  },
  {
    name: "rules",
    path: "/rules",
    file: "D:/1Code/NovisV2/pages/rules.vue",
    children: [],
    meta,
    alias: [],
    component: () => import('./rules.e3ce150a.mjs').then((m) => m.default || m)
  }
];
...
const node_modules__pnpm_nuxt_643_0_0_rc_8_wjgdfmzd44uxx2ctknxhvnu2pm_node_modules_nuxt_dist_pages_runtime_router_mjs_a3y9jq6Oxv = defineNuxtPlugin(async (nuxtApp) => {
...
const node_modules__pnpm__64pinia_43nuxt_640_4_0_d5mafntonofe2rniuxtk66kpji_node_modules__64pinia_nuxt_dist_runtime_plugin_vue3_mjs_vzb7Yj107t = defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  ...
  node_modules__pnpm_nuxt_643_0_0_rc_8_wjgdfmzd44uxx2ctknxhvnu2pm_node_modules_nuxt_dist_head_runtime_lib_vueuse_head_plugin_mjs_0AeJwKOdXb,
  node_modules__pnpm_nuxt_643_0_0_rc_8_wjgdfmzd44uxx2ctknxhvnu2pm_node_modules_nuxt_dist_head_runtime_plugin_mjs_xD1YSVD7aP,
  node_modules__pnpm_nuxt_643_0_0_rc_8_wjgdfmzd44uxx2ctknxhvnu2pm_node_modules_nuxt_dist_pages_runtime_router_mjs_a3y9jq6Oxv,
  _nuxt_unocss_mjs_MzCDxu9LMj,
  node_modules__pnpm__64pinia_43nuxt_640_4_0_d5mafntonofe2rniuxtk66kpji_node_modules__64pinia_nuxt_dist_runtime_plugin_vue3_mjs_vzb7Yj107t
];
const _sfc_main$1 = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import('./error-component.62564fdc.mjs'));
    const nuxtApp = useNuxtApp();
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.0.0-rc.8_wjgdfmzd44uxx2ctknxhvnu2pm/node_modules/nuxt/dist/app/components/nuxt-root.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const layouts = {
  default: vue_cjs_prod.defineAsyncComponent(() => import('./default.eecec8ca.mjs'))
};
...
export { _export_sfc as _, _sfc_main$2 as a, __nuxt_component_0$3 as b, __nuxt_component_1 as c, defineStore as d, entry$1 as default, useHead as u, vue_cjs_prod as v };
